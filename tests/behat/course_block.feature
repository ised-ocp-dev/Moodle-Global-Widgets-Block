...
Feature: globalwidgets blocks in a course
  In order to have one or multiple globalwidgets blocks in a course
  As a teacher
  I need to be able to create and change such blocks

  Scenario: Adding globalwidgets block in a course
