...
/**
 * Block conversion handler for globalwidgets
 */
class moodle1_block_globalwidgets_handler extends moodle1_block_handler {
    ...
    protected function convert_configdata(array $olddata) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'block_globalwidgets');
        ...
        $configdata->format = FORMAT_globalwidgets;
